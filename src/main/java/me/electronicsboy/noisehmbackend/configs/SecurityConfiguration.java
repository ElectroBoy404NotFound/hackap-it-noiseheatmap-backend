package me.electronicsboy.noisehmbackend.configs;
...
import me.electronicsboy.noisehmbackend.exceptions.ErrorResponse;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests()
            .requestMatchers("/userauth/login", "/userauth/signup", "/userauth/refresh").permitAll()
    ...
    public AccessDeniedHandler accessDeniedHandler() {
        return (request, response, accessDeniedException) -> {
            ...
            response.getWriter().write(objectMapper.writeValueAsString(
                new ErrorResponse(ErrorCode.ACCESS_DENIED, "You do not have permission to access this resource", LocalDateTime.now().format(DateTimeFormatter.ISO_DATE_TIME))
            ));
        };
    }
